...
console.log('BOT TOKEN:', Boolean(process.env.SLACK_BOT_TOKEN));
console.log('APP TOKEN:', Boolean(process.env.SLACK_APP_TOKEN));
console.log('ALLOWED USERS:', Boolean(process.env.ALLOWED_USER_IDS));
console.log('=================');
